import { ChainId, JSBI, Percent, Token, WETH } from '@koingfu/koingfuswap-sdk'
...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
    ...
    [ChainId.SMARTBCH]: [WETH[ChainId.SMARTBCH]],
    [ChainId.SMARTBCH_TESTNET]: [WETH[ChainId.SMARTBCH_TESTNET]]
}
