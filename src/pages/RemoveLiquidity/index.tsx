...
import { ChainId, Currency, currencyEquals, ETHER, Percent, WETH } from '@koingfu/koingfuswap-sdk'
            ...
            <>
                <RowBetween>
                    <Text color={theme.text2} fontWeight={500} fontSize={16}>
                        {'KOINGFU ' + currencyA?.getSymbol(chainId) + '/' + currencyB?.getSymbol(chainId)} Burned
                    </Text>
                    <RowFixed>
